...
require  dirname(__DIR__).DIRECTORY_SEPARATOR.'PHPMaile'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'Exception.php';
require dirname( __DIR__).DIRECTORY_SEPARATOR.'PHPMaile'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'PHPMailer.php';
require  dirname(__DIR__).DIRECTORY_SEPARATOR.'PHPMaile'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'SMTP.php';
